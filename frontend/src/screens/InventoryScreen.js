                    ...
                    <View className="bg-white rounded-xl mb-4 shadow-sm border border-gray-100 overflow-hidden">
                        ...
                        >
                            <View>
                                ...
                                <Text className="text-gray-500 text-xs">Avg Price: ₹ {item.average_price.toFixed(2)}/Qtl</Text>
                            </View>
                            <View className="items-end">
                                <Text className="text-2xl font-bold text-green-700">{item.total_bags} <Text className="text-sm font-normal text-gray-500">Bags</Text></Text>
                        ...
                        {expandedGrain === item.grain_id && (
                            <View className="p-4 bg-white">
                                <Text className="font-bold text-gray-600 mb-2 text-xs uppercase tracking-widest">Warehouse Distribution</Text>
                                {item.warehouses.map(wh => (
                                    <View key={wh.id} className="flex-row justify-between py-2 border-b border-gray-50 last:border-0">
                                        ...
                                        <Text className="font-semibold text-gray-900">{wh.bags} Bags ({wh.quintal.toFixed(2)} Qtl)</Text>
                                    </View>
                                ))}
